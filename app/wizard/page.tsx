...
import FormationWaitlistCard from "../components/FormationWaitlistCard";
  ...
  return (
    <div className="min-h-screen bg-[#F0F4FA]">
      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
        ...
        {step === 4 && (
          <div>
            {/* ── Formation waitlist card ── */}
            <FormationWaitlistCard
              companyName={info.companyName}
              stateName={stateInfo.name}
              isNonprofit={isNonprofit}
              corpFee={stateInfo.corpFee}
              nonprofitFee={stateInfo.nonprofitFee}
              userEmail={info.founderEmail}
            />
